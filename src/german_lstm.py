...
#argparse file path
parser = argparse.ArgumentParser(description='German dreamer.')
...
out_path="../02-train_LSTM/german/data/"
last_checkpoint_dir="../02-train_LSTM/german/data/weights/weight_attempt_s02/"
