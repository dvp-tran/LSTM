...
#argparse file path
parser = argparse.ArgumentParser(description='Hollywood dreamer.')
...
out_path="../02-train_LSTM/hollywood/data/"
last_checkpoint_dir="../02-train_LSTM/hollywood/data/weights/weight_attempt_s02/"
...
file_name=out_path+'input/hollywood.txt'
